const hi = 'Hej!'
const hiEng = 'Hi!'
const aboutMeEng = `I'm a 37 year old tech interested, professional photographer and artist, shifting gear to focus on a new career in frontend development and digital design. My dreams are big and I see only possibilities, driven by a passion for creativity and by problem solving in digital development and design.`
const aboutMe2Eng = 'Belivies that working together in an agile envoriment is the best way to reach greater hights!'

const aboutMe = `Nyfiken, social och ansvarsfull, van att bemöta människor på ett professionellt och genuint sätt oavsett sammanhang. Har beskrivits som konsultmässig och pålitlig, drivs av problemlösning och kreativt skapande. En ödmjuk lagspelare som ser det som en självklarhet att både dela med mig av mina kunskaper och ta till mig nya.`
// const aboutMe = `Jag är en nyfiken, teknikintresserad, fotograferande bildkonstnär sadlar om för raketkarriär inom webbutveckling och digital design . Drömmer stort och ser bara möjligheter, drivs av skapandepassion och problemlösning inom digital utveckling och design, med stort behov av kreativt utlopp.`
const aboutMe2 = 'Tror att ett agilt samarbete är det bästa sättet att nå nya, oanade höjder!'

const mainCompetence = 'huvudsakliga kompetenser'
const mainCompetenceEng = 'main competence'
...
const englishEng = 'English'

const iconText = 'Klicka här för mer information'
const iconTextEng = 'Click here for more information'
const languageText = 'Flytande i tal och skrift'
const languageTextEng = 'Fluent in writing and speech'
